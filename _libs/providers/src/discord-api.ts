...
const webhookSchema = z.object({ id: z.string(), name: z.string().nullable().default(""), channel_id: z.string(), token: z.string().nullable().default("") });
...
export { CHANNEL_TYPE_TEXT, CHANNEL_TYPE_CATEGORY };
